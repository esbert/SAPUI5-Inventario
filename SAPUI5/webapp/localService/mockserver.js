            ...
            init: function (oOptionsParameter) {
                ...
                return new Promise(function (fnResolve, fnReject) {
                    ...
                    oManifestModel.attachRequestCompleted(function () {
                        ...
                        var oMainDataSource = oManifestModel.getProperty("/sap.app/dataSources/mainServices");
                        ...
                        if (!oMockServer) { // si no tenemos la instancia
                        ...
                        // compose an error response for arch request
                        ...
                        if (oOptions.metadataError || oUriParameters.get("metadataError")) {
                            aRequests.forEach(function (aEntr) {
                                if (aEntr.path.toString().indexof("$metadata") > -1) {
                                    fnResponse(500, "metadata Error", aEntr);
                                }
                            });
                        };
                        ...
                        if (sErrorParam) {
                            aRequests.forEach(function (aEnrty) {
                                fnResponse(iErrorCode, sErrorParam, aEnrty);
                            });
                        };
